...
\node[binBox] (XHAT) at (0, -\vsep*1.36)  {$\widehat{X}_{cij}$ (At-most-one) \\ \scriptsize $\sum_{r \in \mathcal{M}} X_{cijm} \le \widehat{X}_{cij}$ \\ \scriptsize $X_{cij} \ge \widehat{X}_{cij}$};
